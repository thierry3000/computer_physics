...
\begin{parts}
 ...
 \part Implementieren Sie die Gleichungen \ref{ode2} für allgemeine Parameter in der Funktion \texttt{GleichungODE}, um Sie mithilfe ihres Runge-Kutta-Algorithmuses zu lösen.
